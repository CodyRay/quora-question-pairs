...
def build_model(nb_words, embedding_matrix, num_lstm, num_dense, rate_drop_lstm, rate_drop_dense):
...
def main():
    ...
    stamp = 'lstm_%d_%d_%d_%.2f_%.2f_seed_%d' % (VERSION, num_lstm, num_dense, rate_drop_lstm, rate_drop_dense, s)
    ...
    model = build_model(nb_words, embedding_matrix, num_lstm, num_dense, rate_drop_lstm, rate_drop_dense)
